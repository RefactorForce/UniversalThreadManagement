...
namespace UniversalThreadManagement.Test
{
    ...
    public class PermutationGenerator : IEnumerable
    {
        ...
        public PermutationGenerator(object[] objects) => _objects = (object[])objects.Clone();

        #region IEnumerable Members

        public IEnumerator GetEnumerator() => new PermutationGeneratorEnumerator(_objects);
        ...
        private class PermutationGeneratorEnumerator : IEnumerator
        {
            ...
            public void Reset() => _permutationGeneratorHelper = new PermutationGeneratorHelper(_objects.Length);

            public object Current => _currentPermutation;
            ...
            public bool MoveNext()
            {
                if (_permutationGeneratorHelper.HasMore)
                {
                    ...
                    int[] indices = _permutationGeneratorHelper.GenerateNext();
