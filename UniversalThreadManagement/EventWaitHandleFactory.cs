...
namespace UniversalThreadManagement.Internal
{
    ...
    public static class EventWaitHandleFactory
    {
        ...
        public static AutoResetEvent CreateAutoResetEvent() => new AutoResetEvent(false);

        /// <summary>
        /// Create a new ManualResetEvent object
        /// </summary>
        /// <returns>Return a new ManualResetEvent object</returns>
        public static ManualResetEvent CreateManualResetEvent(bool initialState) => new ManualResetEvent(initialState);
    }
}
