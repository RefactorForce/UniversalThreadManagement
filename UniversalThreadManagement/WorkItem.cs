...
using UniversalThreadManagement; using STP = UniversalThreadManagement.SmartThreadPool;
...
namespace UniversalThreadManagement.Internal
{
    ...
    public partial class WorkItem : IHasWorkItemPriority
    {
        ...
        {
            try { _workItemCompletedEvent?.Invoke(this); }
        ...
        {
            try { _workItemStartedEvent?.Invoke(this); }
            catch // Suppress exceptions
            { }
        }
